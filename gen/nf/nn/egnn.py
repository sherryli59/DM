...
class GCL(torch.nn.Module):
    def __init__(self, input_nf, output_nf, hidden_nf, normalization_factor, aggregation_method,
        ...
        self.edge_mlp = torch.nn.Sequential(
            torch.nn.Linear(input_edge + edges_in_d, hidden_nf),
            act_fn,
            torch.nn.Linear(hidden_nf, hidden_nf),
            act_fn)

        self.node_mlp = torch.nn.Sequential(
            torch.nn.Linear(hidden_nf + input_nf + nodes_att_dim, hidden_nf),
            act_fn,
...
class EquivariantUpdate(torch.nn.Module):
    def __init__(self, hidden_nf, normalization_factor, aggregation_method,
        ...
        linear1 = torch.nn.Linear(input_edge, hidden_nf)
        torch.nn.init.xavier_uniform_(linear1.weight, gain=1)
        linear2 = torch.nn.Linear(hidden_nf, hidden_nf)
...
class EquivariantBlock(torch.nn.Module):
    def __init__(self, hidden_nf, edge_feat_nf=2, device='cuda', act_fn=torch.nn.SiLU(), n_layers=2, attention=True,
        ...
        for i in range(0, n_layers):
            self.add_module("gcl_%d" % i, GCL(self.hidden_nf, self.hidden_nf, self.hidden_nf, edges_in_d=edge_feat_nf,
                                              ...
                                              normalization_factor=self.normalization_factor,
                                              aggregation_method=self.aggregation_method))
        self.add_module("gcl_equiv", EquivariantUpdate(hidden_nf, edges_in_d=edge_feat_nf, act_fn=torch.nn.SiLU(), tanh=tanh,
...
class EGNN(torch.nn.Module):
    def __init__(self, in_node_nf, hidden_nf, cutoff=None, atomic_numbers=None,device='cuda', act_fn=torch.nn.SiLU(), n_layers=3, attention=False,
        ...
        self.embedding = torch.nn.Linear(in_node_nf, self.hidden_nf)
